...
public class Link_Validation {
    public static void linkValidations() {
        ...
        try {
            ...
            oBrowser.navigate().to("file:///C:/Users/windows%2010/SeleniumProj/Eclipse-workspace/Selenium/src/automationAndHtml/Creatinglink.html");
            Thread.sleep(2000);
            ...
            oLinks.get(2).click(); // 3rd link (0-based index)
            Thread.sleep(2000);
            ...
            System.out.println(oBrowser.findElement(By.xpath("//a[@id='link1_id']")).getAttribute("href"));
            ...
            // 6. How many links does not open in a new page
