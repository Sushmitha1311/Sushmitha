...
public class dropDown {
    ...
    public static void dropdownValidations(){
        ...
        try{
            ...
            oBrowser.navigate().to("file:///C:/Users/windows%2010/SeleniumProj/Eclipse-workspace/Selenium/src/automationAndHtml/Dropdownlist.html");
            Thread.sleep(2000);
            ...
            if(flag==0) System.out.println("The city '"+cityName+"' does not exist");
